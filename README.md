...
```
cd existing_repo
git remote add origin https://vm-2d21.inf.h-brs.de/inf_se1_ss23_Team_6_sose23/parkhausservlet.git
git branch -M main
...
- [ ] [Set up project integrations](https://vm-2d21.inf.h-brs.de/inf_se1_ss23_Team_6_sose23/parkhausservlet/-/settings/integrations)
